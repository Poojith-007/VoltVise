...
class ChartsFragment : Fragment() {
    ...
    override fun onResume() {
        super.onResume()
        view?.let { loadCharts(it) }
    }

    private fun loadCharts(view: View) {
        val lineChart = view.findViewById<LineChart>(R.id.usageLineChart)
        val barChart  = view.findViewById<BarChart>(R.id.usageBarChart)
